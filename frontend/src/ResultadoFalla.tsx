...
type ResultadoFallaProps = {
  ...
  onBack: () => void;
  onLogout: () => void;
  onActivateReferencia: () => void;
};

export default function ResultadoFalla({ altitud, preductal, postductal, onBack, onLogout, onActivateReferencia, onGoToReportes }: ResultadoFallaProps) {
    ...
    <div className="min-h-screen w-full flex bg-[#F8FAFC] font-sans text-[#0F1B36]">
      ...
      <div className="ml-[260px] flex-1 flex flex-col min-h-screen">
        ...
        <header className="w-full px-8 py-4 flex justify-between items-center bg-transparent">
          ...
          {/* Stepper (4 Pasos - Etapa Resultado Activa) */}
          <div className="flex items-center gap-2 mx-auto">
            ...
            <div className="flex flex-col items-center">
              <div className="w-7 h-7 rounded-full bg-[#F1F5F9] flex items-center justify-center mb-1 border border-[#E2E8F0]">
                <span className="text-[12px] font-bold text-[#94A3B8]">4</span>
              </div>
              <span className="text-[11px] font-medium text-[#94A3B8]">Próximos pasos</span>
            </div>
          </div>
        ...
        <main className="flex-1 px-8 pb-8 flex flex-col items-center w-full max-w-[900px] mx-auto mt-4">
          ...
          <div className="w-full bg-white rounded-[16px] shadow-[0_4px_24px_rgb(0,0,0,0.03)] p-8">
            ...
            {/* Encabezado de Resultado Crítico */}
            <div className="flex items-center gap-4 mb-8">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#FFE4E6] flex items-center justify-center">
                <span className="text-2xl font-bold text-[#E63956]">!</span>
              </div>
              <div>
                <h2 className="text-[22px] font-bold text-[#0F1B36]">RESULTADO: SOSPECHA DE CARDIOPATÍA</h2>
                <p className="text-[15px] font-bold text-[#E63956] mt-0.5">
                  [ CRITERIO DE FALLA POR ALTITUD ]
                </p>
              </div>
            </div>

            {/* Tarjeta Contenedora de Valores y Alerta Crítica */}
            <div className="w-full bg-[#FFF1F2] border border-[#FECDD3] rounded-[12px] p-6 mb-8">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between pb-6">
                ...
                <div className="flex-1 flex flex-col items-center">
                  ...
                  <div className="flex items-baseline gap-1">
                    <span className="text-[28px] font-bold text-[#E63956]">{preductal}</span>
                    <span className="text-[14px] font-bold text-[#0F1B36]">% SpO2</span>
                  </div>
                </div>

                {/* Separador vertical */}
                <div className="hidden sm:block w-px h-16 border-r border-[#FECDD3] mx-8"></div>
                <div className="sm:hidden h-px w-full border-b border-[#FECDD3] my-6"></div>
                ...
                <div className="flex-1 flex flex-col items-center">
                  ...
                  <div className="flex items-baseline gap-1">
                    <span className="text-[28px] font-bold text-[#E63956]">{postductal}</span>
                    <span className="text-[14px] font-bold text-[#0F1B36]">% SpO2</span>
                  </div>
                </div>
              ...
              {/* Fila Inferior (Advertencia de Diferencia Excesiva) */}
              <div className="border-t border-[#FECDD3] pt-4 mt-2 flex flex-col sm:flex-row items-center justify-center gap-4">
                <div className="flex items-center gap-2">
                  <AlertTriangle className="w-4 h-4 text-[#D97706]" />
                  <p className="text-[14px] font-bold text-[#1E293B]">
                    Diferencia entre extremidades: {diferencia}%
                  </p>
                </div>
                <div className="px-3 py-1 bg-[#FFE4E6] border border-[#FECDD3] rounded-md">
                  <span className="text-[13px] text-[#881337] font-medium">Límite: ≤ 3%</span>
                </div>
              </div>
            ...
            <div className="w-full bg-[#F8FAFC] border border-[#E2E8F0] rounded-[12px] p-6 mb-8">
              ...
              <div className="bg-white border border-dashed border-[#BFDBFE] rounded-[8px] p-5">
                <p className="text-[13px] text-[#334155] leading-relaxed mb-4">
                  Recién nacido de 28h evaluado a {formattedAltitud} m.s.n.m. Presenta saturación preductal de {preductal}% y postductal de {postductal}% (diferencia del {diferencia}%). Al superar el umbral ajustado por altitud (ANDES-CHD), se confirma criterio de FALLA.
                </p>
                <div className="h-px w-full bg-[#F1F5F9] mb-4"></div>
                <div className="flex items-start gap-2 bg-[#FFF1F2] p-3 rounded-md border border-[#FECDD3]">
                  <span className="text-lg">💡</span>
                  <p className="text-[13px] text-[#881337] font-medium leading-relaxed">
                    <span className="font-bold text-[#9F1239]">Sugerencia:</span> Iniciar coordinación prioritaria de traslado hacia Cardiología Pediátrica (<strong>INSN-SB</strong>).
                  </p>
                </div>
              </div>
            ...
            {/* Bloque de Referencia Prioritaria y Telemedicina */}
            <div className="w-full bg-[#FFF1F2] border border-[#FECDD3] rounded-[12px] p-5 mb-8 flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-[14px] font-bold text-[#9F1239]">ACTIVAR REFERENCIA PRIORITARIA Y TELEMEDICINA</h4>
                  <p className="text-[12px] text-[#881337] mt-0.5">Se generará una alerta automática al INSN-SB y se solicitará orientación especializada.</p>
                </div>
              </div>
              <button
                onClick={onActivateReferencia}
